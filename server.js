...
const FACEBOOK_PAGE_ACCESS_TOKEN = 'EAANFeH2SsMUBAO6EfIgvcGrhYy9R4vJUEIr70qbDTUL356VmlHuwIKalZAOWMjgcdTVDLBFkPQZCfbhcHqZClElJXXxWDJfkfWXGcDoPWbzpaheskXMZAZBBzcIPnO0L4pQTAJeksT2Gx2yGCdW0bzFt4NybndMpUHc01TplMlQZDZD';
...
app.get('/webhook', (req, res) => {
    ...
    if (req.query['hub.verify_token'] === 'thisIsACustomKey123') {
